...
| **Timeline** | | | |
| `--timeline-dark` | `#345B63` | `#345B63` | Dark timeline segments |
| `--timeline-neutral` | `#D4B996` | `#D4B996` | Neutral timeline segments |
| `--timeline-light` | `#A2D5F2` | `#5ba8d4` | Light timeline segments |
| `--timeline-welcome` | `#90EE90` | `#1a6d1a` | Welcome/Positive segments |
...
### Cards & Surfaces
*   **Light Mode:** Use subtle shadows (`box-shadow: 0 1px 3px rgba(...)`) for depth.
*   **Dark Mode:** Avoid black shadows. Use lighter background overlays (`--bg-surface-secondary`) or borders (`--border-color`) to define depth.
...
*   `src/Sidebar.css`: Styles specific to the SessionSidebar.
*   `src/TimelineVisualization.css`: Styles for the timeline component.
*   `src/components/`: Reusable UI components.
*   `src/domain/`: Business logic and types (agnostic of UI).
*   `src/App.tsx`: Main application layout.

---
*Generated by Jules AI - Senior Frontend Engineer*
